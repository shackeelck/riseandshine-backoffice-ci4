...
use App\Models\MinibarItemModel;

class MinibarItemController extends ResourceController
{
    protected $modelName = MinibarItemModel::class;
    ...
    public function show($id = null)
    {
        ...
        return $row ? $this->respond($row) : $this->failNotFound('Item not found');
    }
